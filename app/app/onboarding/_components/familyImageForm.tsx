...
interface IFamilyImageFormProps {
  onSubmit: (data: z.infer<typeof familyImageSchema>) => void;
}
    ...
    >
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSubmit)}>
          <div className="flex flex-col gap-8 p-4 rounded-lg bg-white shadow">
            <FormField
...
export default FamilyImageForm;
